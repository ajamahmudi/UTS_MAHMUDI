            ...
            <tbody>
                <tr>
                    ...
                    <td>
                        ...
                        <a href="kamar.php?hapus=<?php echo $result['id_gaji']; ?>" type="button" class="btn btn-danger" onClick="return confirm('Apakah Anda Yakin Ingin Mengirim Uang???')"><i class="fa fa-trash"></i></a>
                    </td>
                </tr>
            </tbody>
        </table>
